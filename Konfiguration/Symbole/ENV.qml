...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="FILE||format('\nCAM-%1',CAM)"/>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="CAM"/>
    <edittype labelontop="0" editable="1" type="0" name="FILE"/>
    <edittype labelontop="0" editable="1" type="0" name="SESSION"/>
