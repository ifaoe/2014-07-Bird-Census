...
-- Users
-- ============================================================================
drop table raw_census;
create table raw_census (
   rcns_id serial primary key,
   session varchar(64),
   epsg int,
   cam  varchar(5),
   img  varchar(64),
   ...
   ly   float8,
   usr varchar(32),
   tm_create timestamp default now()
);
grant all privileges on raw_census to daisi;
grant all privileges on raw_census_rcns_id_seq to daisi;
